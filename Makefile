...
py:
	ipython -i -c "from raypy.types import container as c; from raypy.types import scalar as s; from raypy import _rayforce as r; from raypy.types import queries as q"
