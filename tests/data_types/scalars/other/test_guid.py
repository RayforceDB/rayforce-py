...
def test_guid_from_bytes():
    """Construct from a raw 16-byte identifier."""
    u = uuid.UUID("724f8738-2482-4bb8-aa62-f0e682a58a91")
    assert GUID(u.bytes).value == u


def test_guid_from_bytes_wrong_length_raises():
