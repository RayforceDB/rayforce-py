...
def test_time_from_int_millis():
    """Construct from raw milliseconds since 00:00."""
    assert t.Time(0).value == dt.time(0, 0, 0)
    assert t.Time(52245000).value == dt.time(14, 30, 45)
