...
def test_date_from_int_days():
    """Construct from the raw day offset since the 2000-01-01 epoch."""
    assert t.Date(0).value == dt.date(2000, 1, 1)
    assert t.Date(9261).value == dt.date(2025, 5, 10)
